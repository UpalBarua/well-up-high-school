  ...
  return (
    <div className="container mx-auto p-4 w-10/12">
      ...
      <div className="flex flex-col md:flex-row items-center justify-center space-y-8 md:space-y-0 bg-white rounded-lg">
        ...
        <div className="w-full md:w-2/3 p-8 m-0">
          ...
          <p className="my-5 text-gray-400 font-semibold">
            ...
            assumenda reiciendis ut repellendus eos molestias iusto esse placeat
            necessitatibus! Ipsa rerum perspiciatis doloribus consequatur odio
            cum esse nesciunt quidem quod, similique fugiat optio quasi modi
            repellat praesentium quo. Aliquam neque numquam dolorum, nulla
            tenetur alias enim quibusdam eaque velit sit.
          </p>
        </div>
      </div>
    </div>
